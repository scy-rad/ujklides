        ...
        if ($new_simmed->tmp_status==2)
            {
                ...
                if ( ($new_simmed->student_subject_id != $prev->student_subject_id) && ($prev->student_subject_id>0) )
                    $rowek2.='<td>'.$prev->student_subject_id.'</td><td>'.$prev->student_subject()->student_subject_name."</td>";
                else
                    $rowek2.='<td></td><td></td>';
                if ( ($new_simmed->student_group_id != $prev->student_group_id) && ($prev->student_group_id>0) )

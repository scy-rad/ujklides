  ...
  var methods = {
    ...
    _addScheduleBgData: function _addScheduleBgData(data) {
      return this.each(function () {
        ...
        var $bar = $('<div class="sc_bgBar"><span class="text"></span><span class="subtxt"></span></div>');
        $bar.css({
    ...
    _addScheduleData: function _addScheduleData(timeline, d) {
      ...
      return this.each(function () {
        ...
        var st = Math.ceil((data.startTime - saveData.tableStartTime) / setting.widthTime);
        var et = Math.floor((data.endTime - saveData.tableStartTime) / setting.widthTime);
        var $bar = $('<div class="sc_bar"><span class="head"><span class="time"></span></span><span class="text"></span><span class="subtxt"></span></div>');
        ...
        $node.draggable({
          ...
          stop: function stop() {
            ...
            saveData.schedule[scKey].sdfield = 'sdfield';
        ...
        $node.resizable({
          ...
          stop: function stop() {
            ...
            saveData.schedule[scKey].sdfield = 'sdfield2';
      ...
      return this.each(function () {
        ...
        for (var i = 0; i < $barList.length; i++) {
          ...
          if (baseTimeLineCell.position().left <= $bar.position().left) {
            ...
            saveData.schedule[scKey].sdfield = 'sdfield3';

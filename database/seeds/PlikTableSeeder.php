<?php
//php71-cli artisan db:seed --class=PlikTableSeeder
...
class PlikTableSeeder extends Seeder
{
    ...
    function add_plik_room($aF_room,$aF_plik_directory,$aF_plik_name,$aF_plik_version,$aF_plik_title,$aF_type,$aF_plik_description,$aF_plik_status)
        ...
        $Ftype->save();
            ...
            add_plik_group("manekin Laerdal Simman 3G", "","instr_prod/simman3g_english.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: manekin Laerdal Simman 3G","0");
            ...
            add_plik_group("Jednostka zasilająca Ponta-Agila Drager Ponta-Agila", "","instr_prod/kolumna_ponta.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Jednostka zasilająca Ponta-Agila Drager Ponta-Agila","0");
            add_plik_group("Jednostka zasilająca Movita Drager Movita", "","instr_prod/kolumna_movita.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Jednostka zasilająca Movita Drager Movita","0");
            add_plik_group("Stanowisko do znieczulenia Primus Drager Primus", "","instr_prod/stanowisko_do_znieczulenia_primus.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Stanowisko do znieczulenia Primus Drager Primus","0");
            add_plik_group("Kokpit systemu opieki doraźnej Drager Infinity C500", "","instr_prod/kokpit_infinity_C500.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Kokpit systemu opieki doraźnej Drager Infinity C500","0");
            add_plik_group("Aparat do monitorowania blokady nerwowo-mięśniowej Drager ToFscan", "","instr_prod/aparat_monitorowania_blokady_nerwowej_ToFscan.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Aparat do monitorowania blokady nerwowo-mięśniowej Drager ToFscan","0");
            add_plik_group("Monitor pacjenta Infinity m540 Drager Infinity M540", "","instr_prod/monitor_pacjenta_infinity_m540.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Monitor pacjenta Infinity m540 Drager Infinity M540","0");
            add_plik_group("Stacja dokująca monitora pacjenta Infinity Drager Infinity M500", "","instr_prod/InfinityM540Monitor-InfinityM500DockingStation.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Stacja dokująca monitora pacjenta Infinity Drager Infinity M500","0");
            add_plik_group("Interfejs pulsoksymetru Infinity Drager Infinity Rainbow Mount Kit", "","instr_prod/infinity-rainbow-us.pdf","v. 1","instrukcja producenta",$id_prod,"instrukcja: Interfejs pulsoksymetru Infinity Drager Infinity Rainbow Mount Kit","0");

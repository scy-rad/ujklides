...
class RoomsLekTableSeeder extends Seeder
{
    ...
    function Add2_Storage($aF_room, $aF_type, $aF_number, $aF_name, $aF_Description, $aF_shelf,$aF_sort)
        ...
        $ir=Add2_Room($Center_id, 21, 'B 0.25', 'CM_B0.25_CSM_I', 'b025/b0.25.jpg', 'Sala RatMed 0.25', 'Sala 0.25',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 21, 'B 0.26', 'CM_B0.26_CSM_II', 'b026/b0.25.jpg', 'Sala RatMed 0.26', 'Sala 0.26',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 21, 'B 0.28', 'CM_B0.28_CSM_BLS', 'b028/b0.28.jpg', 'Sala BLS RatMed 28', 'Sala BLS (Basic Life Support) 28',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 21, 'B 0.29', 'CM_B0.29_CSM_karetka', 'b029/b0.29.jpg', 'Karetka', 'Sala Karetki',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 21, 'B 0.30', 'CM_B0.30_CSM_ALS', 'b030/b0.30.jpg', 'Sala ALS RatMed 30', 'Sala ALS (Advanced  Life Support) 30',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        ...
        $ir=Add2_Room($Center_id, 1, 'B 3.28', 'CM_B3.28', 'b328/b3.28.jpg', 'Sala B 3.28', 'Sala B 3.28',0);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 1, 'B 3.29', 'CM_B3.29', 'b329/b3.29.jpg', 'Sala B 3.29', 'Sala B 3.29',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);

        $ir=Add2_Room($Center_id, 1, 'B 3.32', 'CM_B3.32', 'b332/b3.32.jpg', 'Sala 3.32', 'Sala 3.32',1);
            Add2_Storage($ir, $storage_cwicz_magaz, 'sala', 'sala', 'sala', 1, 0);
        ...
        $ir=Add2_Room($Center_id, 3, 'B 1.23', '', 'b123/b1.23.jpg', 'Pokój techników 1', 'Pokój techników 1',1);
            Add2_Storage($ir, $storage_magazynowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 3, 'B 3.31', '', 'b331/b3.31.jpg', 'Pokój techników 2', 'Pokój techników 2',1);
            Add2_Storage($ir, $storage_magazynowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add2_Room($Center_id, 3, 'B 3.30', '', 'b330/b3.30.jpg', 'Pokój plan+tech', 'Pokój plan+tech',1);
            Add2_Storage($ir, $storage_magazynowy, 'sala', 'sala', 'sala', 1, 0);

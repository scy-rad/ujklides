<?php
//php71-cli artisan db:seed --class=ReviewsTableSeeder
...
class ReviewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $id_tmpl=make_review_template('manekin Laerdal Simman 3G','przegląd roczny',4,365,31,14,'<ol>Sprawdzić wszystkie elementy, takie jak:<li>głowę</li><li>ręce</li><li>nogi</li><li>tułów</li><li>monitor pacjenta</li><li>komputer instruktora</li></ol>',1);
        
        $id_tmpl=make_review_template('manekin Laerdal Simman 3G','przegląd semestralny',3,182,45,31,'<ol>Sprawdzić główne elementy, takie jak:<li>głowę</li><li>ręce</li><li>monitor pacjenta</li><li>komputer instruktora</li></ol>',1);
        
        $id_tmpl=make_review_template('manekin Laerdal Simman 3G','przegląd miesięczny',2,31,7,7,'<ol>Sprawdzić najważniejsze elementy, takie jak:<li>monitor pacjenta</li><li>komputer instruktora</li></ol>',1);
            make_review($id_tmpl,'przegląd miesięczny','UJK/S/0009061/2019',date('Y-m-d',strtotime("+7 day")),date('Y-m-d'),date('Y-m-d',strtotime("+14 day")),2);
        
        $id_tmpl=make_review_template('manekin Laerdal Simman 3G','przegląd producenta',51,730,91,0,'Przegląd gwarancyjny',1);
            make_review($id_tmpl,'przegląd gwarancyjny','UJK/S/0009061/2019',date('Y-m-d',strtotime("+91 day")),date('Y-m-d'),date('Y-m-d',strtotime("+91 day")),1);

...
class GalleryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        function put_photos($aF_gallery, $aF_photos_directory, $aF_photos_name, $aF_photos_title, $aF_photos_description)
            ...
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_01.jpg", "widok ogólny symulatora", "widok ogólny symulatora");
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_02.jpg", "symulator zasłonięty płachtą ochronną", "symulator zasłonięty płachtą ochronną");
            ...
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_06.jpg", "peały do robienia prześwietlenia i zdjęć", "peały do robienia prześwietlenia i zdjęć");
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_07.jpg", "złącze do podłączenia endoskopów", "złącze do podłączenia endoskopów");
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_08.jpg", "złącza do podłączania narzędzi endoskopowych", "złącza do podłączania narzędzi endoskopowych");
            put_photos($id_gall, "/storage/images/galerie/bronch_mentor", "bronch_mentor_09.jpg", "złącza podłączeń info-elektrycznych", "złącza podłączeń info-elektrycznych");
          ...
          $id_gall=make_item_gallery("UJK/S/0009106/2020","Symulator USG U/S Mentor 3D Systems U/S Mentor", "Symulator USG U/S Mentor 3D Systems U/S Mentor", "/storage/images/galerie/us_mentor");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_01.jpg", "widok prawie podłączonego symulatora", "widok prawie podłączonego symulatora");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_02.jpg", "widok torsu", "widok torsu");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_03.jpg", "widok torsu - wejście dolne", "widok torsu - wejście dolne");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_04.jpg", "moduł interfejsów", "moduł interfejsów");
            ...
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_07.jpg", "podłączenie torsu do modułu interfejsów", "podłączenie torsu do modułu interfejsów");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_08.jpg", "moduł interfejsów - wyprowadzenia tylne", "moduł interfejsów - wyprowadzenia tylne");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_09.jpg", "moduł interfejsów - podłączenie przednie 1", "moduł interfejsów - podłączenie przednie 1");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_10.jpg", "moduł interfejsów - podłączenie przednie 2,3,4", "moduł interfejsów - podłączenie przednie 2,3,4");
            put_photos($id_gall, "/storage/images/galerie/us_mentor", "us_mentor_11.jpg", "stojak do głowicy USG", "stojak do głowicy USG");
          ...
          $id_gall=make_group_gallery("trenażer do nauki intubacji Airway Larry Nasco LF 03685","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
            put_photos($id_gall, "/storage/images/galerie/intubacja_larry_lf03685", "trenazer_intubacji_larry_01.jpg", "trenażer intubacji z walizką transportową", "trenażer intubacji z walizką transportową");
            put_photos($id_gall, "/storage/images/galerie/intubacja_larry_lf03685", "trenazer_intubacji_larry_02.jpg", "trenażer intubacji", "trenażer intubacji");
            ...
            put_photos($id_gall, "/storage/images/galerie/intubacja_larry_lf03685", "trenazer_intubacji_larry_06.jpg", "strzykawki do uzyskania laryngospazmu i obrzęku języka", "strzykawki do uzyskania laryngospazmu i obrzęku języka");
          $id_gall=make_item_gallery("UJK/N/0104182/2020","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
          ...
          $id_gall=make_item_gallery("UJK/N/0104183/2020","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
          ...
          $id_gall=make_item_gallery("UJK/N/0104184/2020","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
          ...
          $id_gall=make_item_gallery("UJK/N/0104185/2020","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
          ...
          $id_gall=make_item_gallery("UJK/N/0104186/2020","trenażer do nauki intubacji Airway Larry Nasco LF 03685", "trenażer do nauki intubacji Airway Larry Nasco LF 03685", "/storage/images/galerie/intubacja_larry_lf03685");
          ...
          $id_gall=make_group_gallery("trenażer do konikotomii Nasco Delux 135","trenażer do konikotomii Nasco Delux 135", "trenażer do konikotomii Nasco Delux 135", "/storage/images/galerie/konikotomia_delux135");
            put_photos($id_gall, "/storage/images/galerie/konikotomia_delux135", "trenazer_konikotomii_delux135_01.jpg", "kompletny zestaw trenażera", "kompletny zestaw trenażera");
            put_photos($id_gall, "/storage/images/galerie/konikotomia_delux135", "trenazer_konikotomii_delux135_02.jpg", "trenażer konikotomii", "trenażer konikotomii");
            put_photos($id_gall, "/storage/images/galerie/konikotomia_delux135", "trenazer_konikotomii_delux135_03.jpg", "wymienna chrząstka i drogi oddechowe - dziecko", "wymienna chrząstka i drogi oddechowe - dziecko");
            put_photos($id_gall, "/storage/images/galerie/konikotomia_delux135", "trenazer_konikotomii_delux135_04.jpg", "dodatkowe skóry", "dodatkowe skóry");
          ...
          $id_gall=make_item_gallery("UJK/N/0104197/2020","trenażer do konikotomii Nasco Delux 135", "trenażer do konikotomii Nasco Delux 135", "/storage/images/galerie/konikotomia_delux135");
          ...
          $id_gall=make_item_gallery("UJK/N/0104198/2020","trenażer do konikotomii Nasco Delux 135", "trenażer do konikotomii Nasco Delux 135", "/storage/images/galerie/konikotomia_delux135");
          ...
          $id_gall=make_group_gallery("trenażer dostępu dożylnego - tułów Laerdal Laerdal IV Torso","trenażer dostępu dożylnego - tułów Laerdal Laerdal IV Torso", "trenażer dostępu dożylnego - tułów Laerdal Laerdal IV Torso", "/storage/images/galerie/laerdal_iv_torso");
            put_photos($id_gall, "/storage/images/galerie/laerdal_iv_torso", "laerdal_iv_torso_01.jpg", "widok trenażera na walizce transportowej", "widok trenażera na walizce transportowej");
            put_photos($id_gall, "/storage/images/galerie/laerdal_iv_torso", "laerdal_iv_torso_02.jpg", "widok trenażera ze zdjętą pokrywą", "widok trenażera ze zdjętą pokrywą");
          ...
          $id_gall=make_group_gallery("fantom laryngologiczny Nasco LF 01019","fantom laryngologiczny Nasco LF 01019", "fantom laryngologiczny Nasco LF 01019", "/storage/images/galerie/trenazer_laryngologiczny");
            put_photos($id_gall, "/storage/images/galerie/trenazer_laryngologiczny", "trenazer_laryngologiczny_01.jpg", "kompletny zestaw trenażera", "kompletny zestaw trenażera");
          ...
          $id_gall=make_group_gallery("Trenażer do badania oka Rouilly Adam AR 403","Trenażer do badania oka Rouilly Adam AR 403", "Trenażer do badania oka Rouilly Adam AR 403", "/storage/images/galerie/trenazer_oka_ar403");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_01.jpg", "komplet", "komplet");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_02.jpg", "zbliżenie oka", "zbliżenie oka");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_03.jpg", "zbliżenie na ustawienia", "zbliżenie na ustawienia");
          $id_gall=make_item_gallery("UJK/N/0104199/2020","Trenażer do badania oka Rouilly Adam AR 403", "Trenażer do badania oka Rouilly Adam AR 403", "/storage/images/galerie/trenazer_oka_ar403");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_54650.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104200/2020","Trenażer do badania oka Rouilly Adam AR 403", "Trenażer do badania oka Rouilly Adam AR 403", "/storage/images/galerie/trenazer_oka_ar403");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_55032.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104201/2020","Trenażer do badania oka Rouilly Adam AR 403", "Trenażer do badania oka Rouilly Adam AR 403", "/storage/images/galerie/trenazer_oka_ar403");
            put_photos($id_gall, "/storage/images/galerie/trenazer_oka_ar403", "trenazer_oka_54947.jpg", "numer seryjny", "numer seryjny");
          
          $id_gall=make_item_gallery("UJK/S/0009167/2020","Jednostka zasilająca Drager Ponta-Agila", "Jednostka zasilająca Drager Ponta-Agila", "/storage/images/galerie/kolumna_ponta_oit");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_ponta_agila_01.jpg", "widok na całą kolumnę", "widok na całą kolumnę");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_ponta_agila_02.jpg", "oświetlenie górne kolumny", "oświetlenie górne kolumny");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_l_04.jpg", "kolumna lewa - gniazda z tyłu", "kolumna lewa - gniazda z tyłu");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_l_ramie_do_wlewow.jpg", "ramię do wlewów na kolumnie lewej", "ramię do wlewów na kolumnie lewej");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_l_ramie_do_wlewow_tab.jpg", "ramię do wlewów na kolumnie lewej (tabliczka)", "ramię do wlewów na kolumnie lewej (tabliczka)");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_p_02.jpg", "kolumna prawa - przód", "kolumna prawa - przód");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_p_04.jpg", "kolumna prawa - tył", "kolumna prawa - tył");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_p_ramie_obrotowe.jpg", "ramię obrotowe na kolumnie prawej", "ramię obrotowe na kolumnie prawej");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_agila_p_ramie_obrotowe_tab.jpg", "ramię obrotowe na kolumnie prawej (tabliczka)", "ramię obrotowe na kolumnie prawej (tabliczka)");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit", "kolumna_pointa_agila_sn.jpg", "numer seryjny", "numer seryjny");
          
          $id_gall=make_item_gallery("UJK/S/0009166/2020","Jednostka zasilająca Drager Ponta-Agila", "Jednostka zasilająca Drager Ponta-Agila", "/storage/images/galerie/kolumna_ponta_oit_ped");
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit_ped", "kolumna_ponta_agila_ped_01.jpg", "widok na całą kolumnę z mostem", "widok na całą kolumnę z mostem");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_ponta_oit_ped", "kolumna_ponta_agila_ped_05.jpg", "widok kolumny z tyłu", "widok kolumny z tyłu");
          ...
          $id_gall=make_item_gallery("UJK/S/0009168/2020","Panel ścienny Drager Gemina Duo", "Panel ścienny Drager Gemina Duo", "/storage/images/galerie/panel_germinaduo");
          ...
          $id_gall=make_item_gallery("UJK/S/0009169/2020","Panel ścienny Drager Gemina Duo", "Panel ścienny Drager Gemina Duo", "/storage/images/galerie/panel_germinaduo");
          ...
          $id_gall=make_item_gallery("UJK/S/0009170/2020","Panel ścienny Drager Gemina Duo", "Panel ścienny Drager Gemina Duo", "/storage/images/galerie/panel_germinaduo");
          ...
          $id_gall=make_group_gallery("Trenażer udrażniania DO - dziecko Nasco LF 03609","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_01.jpg", "komplet z walizką transportową", "komplet z walizką transportową");
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_02.jpg", "widok trenażera", "widok trenażera");
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_03.jpg", "trenażer z obróconą głową", "trenażer z obróconą głową");
            ...
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_06.jpg", "gąbka ochronna do przechowywania i transportu", "gąbka ochronna do przechowywania i transportu");
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_07.jpg", "zapakowany trenażer", "zapakowany trenażer");
            put_photos($id_gall, "/storage/images/galerie/dziecko_udr_do_lf03609", "dziecko_udr_do_lf03609_08.jpg", "zapakowany trenażer", "zapakowany trenażer");
          ...
          $id_gall=make_item_gallery("UJK/N/0104187/2020","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
          ...
          $id_gall=make_item_gallery("UJK/N/0104188/2020","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
          ...
          $id_gall=make_item_gallery("UJK/N/0104189/2020","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
          ...
          $id_gall=make_item_gallery("UJK/N/0104190/2020","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
          ...
          $id_gall=make_item_gallery("UJK/N/0104191/2020","Trenażer udrażniania DO - dziecko Nasco LF 03609", "Trenażer udrażniania DO - dziecko Nasco LF 03609", "/storage/images/galerie/dziecko_udr_do_lf03609");
          ...
          $id_gall=make_group_gallery("Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            ...
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_03.jpg", "noworodek - widok z tyłu", "noworodek - widok z tyłu");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_04.jpg", "noworodek - górne drogi oddechowe", "noworodek - górne drogi oddechowe");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_05.jpg", "noworodek - płuca (jedne unoszące się jednostronnie)", "noworodek - płuca (jedne unoszące się jednostronnie)");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_06.jpg", "podłączenia żylne oraz skóry doni i stóp", "podłączenia żylne oraz skóry doni i stóp");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_07.jpg", "wada cewy nerwowej, przepuklina pępowinowa i drożna pępowina", "wada cewy nerwowej, przepuklina pępowinowa i drożna pępowina");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_08.jpg", "wada cewy nerwowej, przepuklina pępowinowa i drożna pępowina", "wada cewy nerwowej, przepuklina pępowinowa i drożna pępowina");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_09.jpg", "noworodek - widok po złożeniu", "noworodek - widok po złożeniu");
          ...
          $id_gall=make_item_gallery("UJK/N/0104192/2020","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_sn_693.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104193/2020","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_sn_694.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104194/2020","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_sn_695.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104195/2020","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_sn_696.jpg", "numer seryjny", "numer seryjny");
          $id_gall=make_item_gallery("UJK/N/0104196/2020","Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "Fantom noworodka do RKO i procedur pielęgniarskich Nasco LF 01400", "/storage/images/galerie/noworodek_lf01400");
            put_photos($id_gall, "/storage/images/galerie/noworodek_lf01400", "noworodek_lf01400_sn_697.jpg", "numer seryjny", "numer seryjny");
          
          $id_gall=make_item_gallery("UJK/S/0009164/2020","Jednostka zasilająca Drager Movita", "Jednostka zasilająca Drager Movita", "/storage/images/galerie/kolumna_movita");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_03.jpg", "kolumna movita - widok z tyłu", "kolumna movita - widok z tyłu");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_06.jpg", "kolumna movita - widok z tyłu", "kolumna movita - widok z tyłu");
            ...
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_do_iniekcji_01.jpg", "ramię do iniekcji", "ramię do iniekcji");
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_do_iniekcji_02.jpg", "ramię do iniekcji - numer seryjny", "ramię do iniekcji - numer seryjny");
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_obrotowe_a_01.jpg", "ramię obrotowe", "ramię obrotowe");
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_obrotowe_a_02.jpg", "ramię obrotowe - numer seryjny", "ramię obrotowe - numer seryjny");
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_obrotowe_b_01.jpg", "ramię obrotowe", "ramię obrotowe");
            put_photos($id_gall, "/storage/images/galerie/kolumna_movita", "kolumna_movita_ramie_obrotowe_b_02.jpg", "ramię obrotowe - numer seryjny", "ramię obrotowe - numer seryjny");
          ...
          $id_gall=make_item_gallery("UJK/S/0009163/2020","Stanowisko do znieczulenia Drager Primus", "Stanowisko do znieczulenia Drager Primus", "/storage/images/galerie/primus");
            ...
            put_photos($id_gall, "/storage/images/galerie/primus", "stanowisko_do_znieczulania_02.jpg", "Stanowisko do znieczulania - zbliżenie", "Stanowisko do znieczulania - zbliżenie");
            ...
            put_photos($id_gall, "/storage/images/galerie/primus", "stanowisko_do_znieczulania_04.jpg", "uchwyt na parowniki do anestetyków", "uchwyt na parowniki do anestetyków");
            ...
            put_photos($id_gall, "/storage/images/galerie/primus", "stanowisko_do_znieczulania_11.jpg", "podłączenie gazów", "podłączenie gazów");
            ...
            put_photos($id_gall, "/storage/images/galerie/primus", "stanowisko_do_znieczulania_13.jpg", "podłączenia sygnałowe", "podłączenia sygnałowe");
            put_photos($id_gall, "/storage/images/galerie/primus", "stanowisko_do_znieczulania_14.jpg", "podłączenie zasilania", "podłączenie zasilania");
          ...
          $id_gall=make_item_gallery("UJK/S/0009165/2020","Infinity Drager: Kokpit systemu opieki doraźnej C500", "Infinity Drager: Kokpit systemu opieki doraźnej C500", "/storage/images/galerie/infinity_c500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_01.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_02.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_03.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_04.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_05.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p1_a.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p1_b.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p1_c.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p1_d.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p2_a.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p2_b.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p3_a.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_p3_b.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_sn_1.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_sn_2.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
            put_photos($id_gall, "/storage/images/galerie/infinity_c500", "infinity_kokpit_500_zasilacz.jpg", "Kokpit systemu opieki doraźnej C500", "Kokpit systemu opieki doraźnej C500");
          ...
          $id_gall=make_item_gallery("UJK/S/0009165/2020 - 4","Infinity Drager: Stacja dokująca monitora pacjenta M500", "Infinity Drager: Stacja dokująca monitora pacjenta M500", "/storage/images/galerie/infinity_m500");
            put_photos($id_gall, "/storage/images/galerie/infinity_m500", "infinity_stac_dok_m500_01.jpg", "stacja dokująca M500", "stacja dokująca M500");
            put_photos($id_gall, "/storage/images/galerie/infinity_m500", "infinity_stac_dok_m500_02.jpg", "stacja dokująca M500", "stacja dokująca M500");
            put_photos($id_gall, "/storage/images/galerie/infinity_m500", "infinity_stac_dok_m500_03.jpg", "stacja dokująca M500", "stacja dokująca M500");
            put_photos($id_gall, "/storage/images/galerie/infinity_m500", "infinity_stac_dok_m500_04.jpg", "stacja dokująca M500", "stacja dokująca M500");
          ...
          $id_gall=make_item_gallery("UJK/S/0009165/2020 - 2","Infinity Drager: Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Infinity Drager: Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "/storage/images/galerie/infinity_tofscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan01.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan02.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan03.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan04.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan05.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
            put_photos($id_gall, "/storage/images/galerie/infinity_tofscan", "tofscan06.jpg", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan", "Aparat do monitorowania blokady nerwowo-mięśniowej ToFscan");
          ...
          $id_gall=make_group_gallery("Resusci Anne QCPR","Resusci Anne QCPR", "Resusci Anne QCPR", "/storage/images/galerie/resusci_anne_qcpr_torso");
            put_photos($id_gall, "/storage/images/galerie/resusci_anne_qcpr_torso", "resusci_anne_qcpr_01.jpg", "Fantom BLS dorosłego - Resusci Anne QCPR", "Fantom BLS dorosłego - Resusci Anne QCPR");
          ...
          $id_gall=make_item_gallery("UJK/S/0009138/2020","Pediatric Hal S3005", "Pediatric Hal S3005", "/storage/images/galerie/pediatric_hal_s3005");
            ...
            $ret_gal=make_room_gallery("A 1.05","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05a.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05b.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05c.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05d.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05e.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/a105","a1.05f.jpg","Sala umiejętności technicznych - położnictwo","Sala umiejętności technicznych - położnictwo");
            $ret_gal=make_room_gallery("A 1.06","Sala umiejętności pielęgniarskich","Sala umiejętności pielęgniarskich");
            put_photos($ret_gal,"/storage/images/rooms/a106","a1.06a.jpg","Sala umiejętności pielęgniarskich","Sala umiejętności pielęgniarskich");
            put_photos($ret_gal,"/storage/images/rooms/a106","a1.06b.jpg","Sala umiejętności pielęgniarskich","Sala umiejętności pielęgniarskich");
            put_photos($ret_gal,"/storage/images/rooms/a106","a1.06c.jpg","Sala umiejętności pielęgniarskich","Sala umiejętności pielęgniarskich");
            put_photos($ret_gal,"/storage/images/rooms/a106","a1.06d.jpg","Sala umiejętności pielęgniarskich","Sala umiejętności pielęgniarskich");
            $ret_gal=make_room_gallery("A 1.07","Sala umiejętności technicznych - pielęgniarstwo","Sala umiejętności technicznych - pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/a107","a1.07a.jpg","Sala umiejętności technicznych - pielęgniarstwo","Sala umiejętności technicznych - pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/a107","a1.07b.jpg","Sala umiejętności technicznych - pielęgniarstwo","Sala umiejętności technicznych - pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/a107","a1.07c.jpg","Sala umiejętności technicznych - pielęgniarstwo","Sala umiejętności technicznych - pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/a107","a1.07d.jpg","Sala umiejętności technicznych - pielęgniarstwo","Sala umiejętności technicznych - pielęgniarstwo");
            $ret_gal=make_room_gallery("A 1.08","Wejście do sal niskiej wierości pielęgniarskiej","Wejście do sal niskiej wierości pielęgniarskiej");
            put_photos($ret_gal,"/storage/images/rooms/a108","a1.08wejscie.jpg","Wejście do sal niskiej wierości pielęgniarskiej","Wejście do sal niskiej wierości pielęgniarskiej");
            $ret_gal=make_room_gallery("A 1.09","Sala umiejętności położniczych","Sala umiejętności położniczych");
            put_photos($ret_gal,"/storage/images/rooms/a109","a1.09a.jpg","Sala umiejętności położniczych","Sala umiejętności położniczych");
            put_photos($ret_gal,"/storage/images/rooms/a109","a1.09b.jpg","Sala umiejętności położniczych","Sala umiejętności położniczych");
            put_photos($ret_gal,"/storage/images/rooms/a109","a1.09c.jpg","Sala umiejętności położniczych","Sala umiejętności położniczych");
            put_photos($ret_gal,"/storage/images/rooms/a109","a1.09d.jpg","Sala umiejętności położniczych","Sala umiejętności położniczych");
            $ret_gal=make_room_gallery("B 1.01","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01a.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01b.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01c.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01d.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01e.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            put_photos($ret_gal,"/storage/images/rooms/b101","b1.01f.jpg","Wysoka wierność pielęgniarstwo","Wysoka wierność pielęgniarstwo");
            $ret_gal=make_room_gallery("B 1.05","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05a.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05b.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05c.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05d.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05e.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05f.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05g.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05h.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            put_photos($ret_gal,"/storage/images/rooms/b105","b1.05i.jpg","Wysoka wierność położnictwo","Wysoka wierność położnictwo");
            ...
            $ret_gal=make_room_gallery("B 1.12","OSCE  - położnictwo 12","OSCE  - położnictwo 12");
            put_photos($ret_gal,"/storage/images/rooms/b112","b1.12a.jpg","OSCE  - położnictwo 12","OSCE  - położnictwo 12");
            put_photos($ret_gal,"/storage/images/rooms/b112","b1.12b.jpg","OSCE  - położnictwo 12","OSCE  - położnictwo 12");
            put_photos($ret_gal,"/storage/images/rooms/b112","b1.12c.jpg","OSCE  - położnictwo 12","OSCE  - położnictwo 12");
            put_photos($ret_gal,"/storage/images/rooms/b112","b1.12d.jpg","OSCE  - położnictwo 12","OSCE  - położnictwo 12");
            $ret_gal=make_room_gallery("B 1.13","OSCE  - położnictwo 13","OSCE  - położnictwo 13");
            put_photos($ret_gal,"/storage/images/rooms/b113","b1.13a.jpg","OSCE  - położnictwo 13","OSCE  - położnictwo 13");
            put_photos($ret_gal,"/storage/images/rooms/b113","b1.13b.jpg","OSCE  - położnictwo 13","OSCE  - położnictwo 13");
            put_photos($ret_gal,"/storage/images/rooms/b113","b1.13c.jpg","OSCE  - położnictwo 13","OSCE  - położnictwo 13");
            put_photos($ret_gal,"/storage/images/rooms/b113","b1.13d.jpg","OSCE  - położnictwo 13","OSCE  - położnictwo 13");
            ...
            $ret_gal=make_room_gallery("B 1.15","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            put_photos($ret_gal,"/storage/images/rooms/b115","b1.15a.jpg","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            put_photos($ret_gal,"/storage/images/rooms/b115","b1.15b.jpg","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            put_photos($ret_gal,"/storage/images/rooms/b115","b1.15c.jpg","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            put_photos($ret_gal,"/storage/images/rooms/b115","b1.15d.jpg","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            put_photos($ret_gal,"/storage/images/rooms/b115","b1.15e.jpg","OSCE  - pielęgniarstwo 15","OSCE  - pielęgniarstwo 15");
            $ret_gal=make_room_gallery("B 1.16","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            put_photos($ret_gal,"/storage/images/rooms/b116","b1.16a.jpg","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            put_photos($ret_gal,"/storage/images/rooms/b116","b1.16b.jpg","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            put_photos($ret_gal,"/storage/images/rooms/b116","b1.16c.jpg","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            put_photos($ret_gal,"/storage/images/rooms/b116","b1.16d.jpg","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            put_photos($ret_gal,"/storage/images/rooms/b116","b1.16e.jpg","OSCE  - pielęgniarstwo 16","OSCE  - pielęgniarstwo 16");
            $ret_gal=make_room_gallery("B 1.17","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            put_photos($ret_gal,"/storage/images/rooms/b117","b1.17a.jpg","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            put_photos($ret_gal,"/storage/images/rooms/b117","b1.17b.jpg","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            put_photos($ret_gal,"/storage/images/rooms/b117","b1.17c.jpg","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            put_photos($ret_gal,"/storage/images/rooms/b117","b1.17d.jpg","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            put_photos($ret_gal,"/storage/images/rooms/b117","b1.17e.jpg","OSCE  - pielęgniarstwo 17","OSCE  - pielęgniarstwo 17");
            $ret_gal=make_room_gallery("B 1.18","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            put_photos($ret_gal,"/storage/images/rooms/b118","b1.18a.jpg","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            put_photos($ret_gal,"/storage/images/rooms/b118","b1.18b.jpg","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            put_photos($ret_gal,"/storage/images/rooms/b118","b1.18c.jpg","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            put_photos($ret_gal,"/storage/images/rooms/b118","b1.18d.jpg","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            put_photos($ret_gal,"/storage/images/rooms/b118","b1.18e.jpg","OSCE  - pielęgniarstwo 18","OSCE  - pielęgniarstwo 18");
            ...
            put_photos($ret_gal,"/storage/images/rooms/d009","d0.09a.jpg","Szpitalny Oddział Ratunkowy","Szpitalny Oddział Ratunkowy");
            put_photos($ret_gal,"/storage/images/rooms/d009","d0.09b.jpg","Szpitalny Oddział Ratunkowy","Szpitalny Oddział Ratunkowy");
            put_photos($ret_gal,"/storage/images/rooms/d009","d0.09c.jpg","Szpitalny Oddział Ratunkowy","Szpitalny Oddział Ratunkowy");
            put_photos($ret_gal,"/storage/images/rooms/d009","d0.09d.jpg","Szpitalny Oddział Ratunkowy","Szpitalny Oddział Ratunkowy");
            put_photos($ret_gal,"/storage/images/rooms/d009","d0.09e.jpg","Szpitalny Oddział Ratunkowy","Szpitalny Oddział Ratunkowy");

...
class RoomsTableSeeder extends Seeder
{
    ...
    function Add_Storage($aF_room, $aF_type, $aF_number, $aF_name, $aF_Description, $aF_shelf,$aF_sort)
        ...
        $ir=Add_Room($Center_id, 3, '_MW', '', '', 'Magazyn Wejściowy', 'Magazyn sprzętów przychodzących',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);

        
        $ir=Add_Room($Center_id, 1, 'A 1.05', 'CM_A1.05_CSM_II', 'a105/a1.05a.jpg', 'Umiejętności techniczne - położnictwo', 'Sala umiejętności technicznych - położnictwo',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
        ...
        $ir=Add_Room($Center_id, 1, 'A 1.06',  'CM_A1.06_CSM_II','a106/a1.06a.jpg', 'Umiejętności pielęgniarskie', 'Sala umiejętności pielęgniarskich',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            for ($i=1; $i<=4; $i++)
        ...
        $ir=Add_Room($Center_id, 1, 'A 1.07', 'CM_A1.07_CSM_II', 'a107/a1.07c.jpg', 'Umiejętności techniczne - pielęgniarstwo', 'Sala umiejętności technicznych - pielęgniarstwo',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            for ($i=1; $i<=3; $i++) 
                Add_Storage($ir, $storage_magazynowy, 'szafka W'.str_pad($i, 2, 0, STR_PAD_LEFT), 'Szafka wisząca '.$i.'-M', 'Szafka wisząca magazynowa '.$i, 2, $sort_count++);
        ...
        $ir=Add_Room($Center_id, 4, 'A 1.08', '', 'a108/a1.08wejscie.jpg', 'Komunikacja sal', 'Komunikacja sal - pielęgniarstwo i położnictwo',1);
        ...
        $ir=Add_Room($Center_id, 1, 'A 1.09', 'CM_A1.09_CSM_II', 'a109/a1.09a.jpg', 'Sala umiejętności położniczych', 'Sala umiejętności położniczych',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
        ...
        $ir=Add_Room($Center_id, 11, 'B 1.01', 'CM_B1.01', 'b101/b1.01a.jpg', 'Wysoka Wierność Pielęgniarstwo', 'Sala Wysokiej Wierności Opieki Pielęgniarskiej',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            for ($i=1; $i<=5; $i++)
        ...
        $ir=Add_Room($Center_id, 2, 'B 1.02', '', 'b102/b1.02.jpg', 'Pomieszczenie kontrolne (B 1.01)', 'pomieszczenie kontrolne przy sali B 1.01',1);
            Add_Storage($ir, $storage_magazynowy, 'sala', 'sala', 'sala', 1, 0);
        
        $ir=Add_Room($Center_id, 2, 'B 1.03', '', 'b103/b1.03.jpg', 'Pomieszczenie kontrolne (B 1.05)', 'pomieszczenie kontrolne przy sali B 1.05',1);
            Add_Storage($ir, $storage_magazynowy, 'sala', 'sala', 'sala', 1, 0);

        $ir=Add_Room($Center_id, 11, 'B 1.05', 'CM_B1.05', 'b105/b1.05a.jpg', 'Wysoka Wierność Położnictwo', 'Sala Wysokiej Wierności Położnicza',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            for ($i=1; $i<=6; $i++) 
                Add_Storage($ir, $storage_cwiczeniowy, 'szafka W'.str_pad($i, 2, 0, STR_PAD_LEFT), 'Szafka wisząca '.$i.'-C', 'Szafka wisząca ćwiczeniowa '.$i, 2, $sort_count++);
        ...
        $ir=Add_Room($Center_id, 3, 'B 1.06', '', 'b106/b1.06.jpg', 'mag-L', 'Magazyn (pomieszczenie lewe)',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add_Room($Center_id, 3, 'B 1.07', '', 'b107/b1.07.jpg', 'mag-S', 'Magazyn (pomieszczenie środkowe)',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add_Room($Center_id, 3, 'B 1.08', '', 'b108/b1.08.jpg', 'mag-K', 'Magazyn-komunikacja (pomieszczenie przejściowe)',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'korytarz', 'korytarz', 'korytarz', 1, 0);
        $ir=Add_Room($Center_id, 3, 'B 1.09', '', 'b109/b1.09.jpg', 'mag-P', 'Magazyn (pomieszczenie prawe)',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add_Room($Center_id, 4, 'B 1.11', '', 'b111/b1.11.jpg', 'OSCE-KomPol', 'komunikacja OSCE Położnictwo',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'korytarz', 'korytarz', 'korytarz', 1, 0);

        $ir=Add_Room($Center_id, 1, 'B 1.12', 'CM_B1.12_CSM_II', 'b112/b1.12a.jpg', 'OSCE Poł 01', 'Sala Egzaminacyjna OSCE - położnictwo 01',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            Add_Storage($ir, $storage_cwiczeniowy, 'blat 01', 'Blat roboczy 1-C', 'Blat roboczy ćwiczeniowy 1', 1, $sort_count++);
        ...
        $ir=Add_Room($Center_id, 1, 'B 1.13', 'CM_B1.13_CSM_II', 'b113/b1.13a.jpg', 'OSCE Poł 02', 'Sala Egzaminacyjna OSCE - położnictwo 02',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            Add_Storage($ir, $storage_cwiczeniowy, 'blat 01', 'Blat roboczy 1-C', 'Blat roboczy ćwiczeniowy 1', 1, $sort_count++);
            Add_Storage($ir, $storage_cwiczeniowy, 'szafka P01', 'Szafka podblatowa 1-C', 'Szafka podblatowa ćwiczeniowa 1', 2, $sort_count++);
        ...
        $ir=Add_Room($Center_id, 2, 'B 1.14', '', 'b114/b1.14a.jpg', 'OSCE kontrolka', 'Sala Egzaminacyjna OSCE - kontrolka',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        
        $ir=Add_Room($Center_id, 11, 'B 1.15', 'CM_B1.15_CSM_II', 'b115/b1.15a.jpg', 'OSCE Pie 01', 'Sala Egzaminacyjna OSCE - pielęgniarstwo 01',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            Add_Storage($ir, $storage_cwiczeniowy, 'blat 01', 'Blat roboczy 1-C', 'Blat roboczy ćwiczeniowy 1', 1, $sort_count++);
            Add_Storage($ir, $storage_cwiczeniowy, 'szafka P01', 'Szafka podblatowa 1-C', 'Szafka podblatowa ćwiczeniowa 1', 2, $sort_count++);
        ...
        $ir=Add_Room($Center_id, 11, 'B 1.16', 'CM_B1.16_CSM_II', 'b116/b1.16a.jpg', 'OSCE Pie 02', 'Sala Egzaminacyjna OSCE - pielęgniarstwo 02',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
            $sort_count=1;
            Add_Storage($ir, $storage_cwiczeniowy, 'blat 01', 'Blat roboczy 1-C', 'Blat roboczy ćwiczeniowy 1', 1, $sort_count++);
            Add_Storage($ir, $storage_cwiczeniowy, 'szafka P01', 'Szafka podblatowa 1-C', 'Szafka podblatowa ćwiczeniowa 1', 2, $sort_count++);
            Add_Storage($ir, $storage_cwiczeniowy, 'szafka P02', 'Szafka podblatowa 2-C', 'Szafka podblatowa ćwiczeniowa 2', 3, $sort_count++);
            Add_Storage($ir, $storage_cwiczeniowy, 'szafka P03', 'Szafka podblatowa 3-M', 'Szafka podblatowa magazynowa 3', 2, $sort_count++);
        $ir=Add_Room($Center_id, 11, 'B 1.17', 'CM_B1.17_CSM_II', 'b117/b1.17a.jpg', 'OSCE Pie 03', 'Sala Egzaminacyjna OSCE - pielęgniarstwo 03',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add_Room($Center_id, 11, 'B 1.18', 'CM_B1.18_CSM_II', 'b118/b1.18a.jpg', 'OSCE Pie 04', 'Sala Egzaminacyjna OSCE - pielęgniarstwo 04',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'sala', 'sala', 'sala', 1, 0);
        $ir=Add_Room($Center_id, 4, 'B 1.19', '', 'b119/b1.19.jpg', 'OSCE-KomPiel', 'komunikacja OSCE Pielęgniarstwo',1);
            Add_Storage($ir, $storage_cwiczeniowy, 'korytarz', 'korytarz', 'korytarz', 1, 0);

...
class WorkTimesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $ret_work_breake=add_work_time_type('work_breake', $out_work, 'out_work', 'poza pracą', 'wyjście z pracy', 'czas, kiedy wychodzi się z pracy (przerwa na wyjście prywatne)');
